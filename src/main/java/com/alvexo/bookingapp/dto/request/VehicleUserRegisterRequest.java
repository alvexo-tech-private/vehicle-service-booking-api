...
@Data
@Schema(description = "Vehicle user registration — creates a VEHICLE_USER account")
public class VehicleUserRegisterRequest {
    ...
    @Schema(description = "10-15 digit mobile number", example = "9876543210",
    ...
    @Schema(description = "Area within city", example = "T Nagar", nullable = true)
    private String area;
